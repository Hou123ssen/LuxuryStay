...
const ACTION_COPY = {
  review: {
    ...
    body: 'Add optional internal notes before marking this report as reviewed.',
    button: 'Mark reviewed',
  },
  resolve: {
    title: 'Resolve report',
    body: 'Add optional internal notes before closing this report as resolved.',
    button: 'Resolve report',
  },
  reject: {
    title: 'Reject report',
    body: 'Add optional internal notes before closing this report as rejected.',
    button: 'Reject report',
  },
};

export default function ModerateReportModal({
  action,
  report,
  loading = false,
  onClose,
  ...
  if (!copy || !report) return null;

  const handleSubmit = async (event) => {
    event.preventDefault();
    const updated = await onConfirm(action, report, {
